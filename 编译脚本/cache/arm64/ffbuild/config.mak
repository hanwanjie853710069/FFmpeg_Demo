...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=arm64 --cc='xcrun -sdk iphoneos clang' --as='gas-preprocessor.pl -arch aarch64 -- xcrun -sdk iphoneos clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --extra-cflags='-arch arm64 -mios-version-min=7.0 -fembed-bitcode' --extra-ldflags='-arch arm64 -mios-version-min=7.0 -fembed-bitcode' --prefix='/Users/xiaojie/Desktop/编译脚本/dream-ffmpeg-iOS/arm64'
...
SRC_PATH=/Users/xiaojie/Desktop/编译脚本/ffmpeg-3.4
SRC_LINK=src
ifndef MAIN_MAKEFILE
SRC_PATH:=$(SRC_PATH:.%=..%)
endif
CC_IDENT=Apple LLVM version 9.0.0 (clang-900.0.37)
ARCH=aarch64
INTRINSICS=neon
...
CFLAGS=  -arch arm64 -mios-version-min=7.0 -fembed-bitcode -std=c11 -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -arch arm64 -mios-version-min=7.0 -fembed-bitcode -fPIC -Qunused-arguments
...
DOXYGEN=doxygen
LDFLAGS= -arch arm64 -mios-version-min=7.0 -fembed-bitcode  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-framework CoreFoundation -framework VideoToolbox -framework CoreMedia -framework CoreVideo -liconv -lm  -lbz2 -lz -pthread -pthread -framework VideoToolbox -framework CoreImage -framework AVFoundation -framework AudioToolbox 
COMPAT_OBJS=
INSTALL=install
LIBTARGET=
